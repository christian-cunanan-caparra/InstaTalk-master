...
class SamuelChatPage extends StatelessWidget {
  const SamuelChatPage({super.key});
  ...
  Widget build(BuildContext context) {
    List<Map<String, String>> messages = [
      ...
      {"text": "luto ko yan", "type": "sent"},
      {"text": "oo sir masarap thanks ulit nabusog ako.", "type": "received"},
    ];
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return message["type"] == "sent"
            ...
            : _buildReceivedMessage(message["text"]!, "images/sam.jpg", context);
      },
    );
  }
